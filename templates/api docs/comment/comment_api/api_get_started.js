...
<title>Micro Api - Authentication</title>
</head>
<body id ="auth">
  <!-- Header start here -->
...
<!-- Main body goes here -->
<article class="getstarted">
    <div class="heading">
        <h1>Get Started With Authentication MicroAPI</h1>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique consequuntur quis doloremque quae temporibus nisi vel delectus veritatis corporis reiciendis aperiam illum earum doloribus quam tenetur, possimus, rem cupiditate consequatur?</p>
      
      </div>
    <div class="code">
    <div>
      <img src="./assets/img/Group 638.png " alt="no-code tool"/>
      <p> No-Code Tool</p>
    </div>
    <div class="v2"></div>
    <div>
        <img src="./assets/img/solution 1.png" alt="no-code tool"/>
        <p> Easy Integration</p>
      </div>
      <div class="v2"></div>
      <div>
          <img src="./assets/img/bolt 1.png" alt="no-code tool"/>
...
<article class="frameworks">
  <p>Seamless integration with your favourite frameworks</p>
<div class="frame_img">
  <img src="./assets/img/flutter_wave 1.png" alt="next"/>
  <img src="./assets/img/reacticon 2.png" alt="react"/>
  <img src="./assets/img/ember-icon.png" alt="ember"/>
  <img src="./assets/img/vuelog.png" alt="Vue"/> 
  <img src="./assets/img/angularicon2.jpg" alt="Angular"/>
  <img src="./assets/img/gatsby-icon.png" alt="Gatsby"/>
...
<article class="features">
  <div class="features_heading">
      <h4>Features</h4>
      <p>See features that let you speed up and mange your user's authentication seamlessly</p>
      
  </div>
  <div class="boxes">
      <div>
          <h3>SIGN IN/SIGN UP</h3>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi adipisci ratione ipsam ducimus sed, voluptatum impedit iure molestiae architecto facilis minus nihil nostrum temporibus, fugit saepe vel optio consectetur laboriosam.</p>
...
<article class="searchbar">
  <h1>Ready to try this out?</h1>
  <p> Get 500 free request on our Authentication API for a year with unlimited support</p>
